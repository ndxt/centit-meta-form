...
@Repository
public class MdColumnDao extends BaseDaoImpl<MdColumn,com.centit.metaform.po.MdColumnId>
	{

	public static final Log log = LogFactory.getLog(MdColumnDao.class);
