...
//字段元数据表 的主键
@Embeddable
public class PendingMdColumnId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PendingMdColumnId))
			return false;
		
		PendingMdColumnId castOther = (PendingMdColumnId) other;
		boolean ret = true;
