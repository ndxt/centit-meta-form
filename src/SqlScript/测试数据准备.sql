...
insert into M_MODEL_OPERATION(MODEL_CODE,OPERATION,OPT_MODEL_CODE,METHOD,LABEL,
	 DISPLAY_ORDER,OPEN_TYPE,OPT_HINT_INFO,EXTEND_OPTIONS,OPT_MODEL_TYPE,DISPLAY_POSTION,OPT_MESSAGE )
	 select 'OPPORT_CONTRACTS',OPERATION,'OPPORT_CONTRACTS',METHOD,LABEL,
	 DISPLAY_ORDER,OPEN_TYPE,OPT_HINT_INFO,EXTEND_OPTIONS,OPT_MODEL_TYPE,DISPLAY_POSTION,OPT_MESSAGE
	 from M_MODEL_OPERATION where MODEL_CODE='NEW_OPPORTUNITIE';
	 
insert into M_MODEL_OPERATION(MODEL_CODE,OPERATION,OPT_MODEL_CODE,METHOD,LABEL,
 DISPLAY_ORDER,OPEN_TYPE,OPT_HINT_INFO,EXTEND_OPTIONS,OPT_MODEL_TYPE,DISPLAY_POSTION,OPT_MESSAGE )
 select 'OPPORT_EXPENSES',OPERATION,'OPPORT_EXPENSES',METHOD,LABEL,
 DISPLAY_ORDER,OPEN_TYPE,OPT_HINT_INFO,EXTEND_OPTIONS,OPT_MODEL_TYPE,DISPLAY_POSTION,OPT_MESSAGE
 from M_MODEL_OPERATION where MODEL_CODE='NEW_OPPORTUNITIE';
