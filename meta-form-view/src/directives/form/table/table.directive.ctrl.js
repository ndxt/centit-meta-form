(function() {
  ...
  angular.module('metaForm')
    .controller('FormTableController', FormTableController);

  /* @ngInject */
  function FormTableController($scope, $state, FormAPI) {
    ...
    function search(params) {
      ...
      return $scope.tablePromise = FormAPI.one(modelCode)
        .customGETLIST('list', angular.extend({noMeta: $scope.formModel ? true : undefined}, params))
        .then(function(data) {
          $scope.items = data;
          if (data.formModel) {
